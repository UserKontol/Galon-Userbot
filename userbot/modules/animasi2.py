...
@galoncmd(pattern=r"^\.anjay$")
async def anjay(njay):
    await njay.edit(AENJEAYE)


@galoncmd(pattern=r"^\.(\w+)say (.*)")
...
@galoncmd(pattern=r"^\.(yes|no|maybe|decide)$")
...
@galoncmd(pattern=r"^\.fp$")
async def facepalm(e):
    await e.edit("🤦‍♂")


@galoncmd(pattern=r"^\.cry$")
async def cry(e):
    await e.edit(choice(CRI))


@galoncmd(pattern=r"^\.insult$")
async def insult(e):
    await e.edit(choice(INSULT_STRINGS))


@galoncmd(pattern=r"^\.cp(?: |$)(.*)")
...
@galoncmd(pattern=r"^\.hello$")
async def hoi(hello):
    await hello.edit(choice(HELLOSTR))


@galoncmd(pattern=r"^\.owo(?: |$)(.*)")
async def focos(owo):
...
@galoncmd(pattern=r"^\.react$")
async def react_meme(react):
    await react.edit(choice(FACEREACTS))


@galoncmd(pattern=r"^\.shg$")
async def shrugger(shg):
    await shg.edit(choice(SHGS))


@galoncmd(pattern=r"^\.chase$")
async def police(chase):
    await chase.edit(choice(CHASE_STR))


@galoncmd(pattern=r"^\.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))


@galoncmd(pattern=r"^\.metoo$")
async def metoo(hahayes):
    await hahayes.edit(choice(METOOSTR))


@galoncmd(pattern="^Oof$")
async def Oof(e):
    t = "Oof"
    for _ in range(15):
        t = t[:-1] + "of"
...
@galoncmd(pattern=r"^\.10iq$")
async def iqless(e):
    await e.edit("♿")


@galoncmd(pattern=r"^\.fuck$")
async def iqbot(e):
    await e.edit("🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕")


@galoncmd(pattern=r"^\.bye$")
async def iqboot(e):
    await e.edit("Kek thx bye")


@galoncmd(pattern=r"^\.moon$")
...
@galoncmd(pattern=r"^\.taco$")
async def taco(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(r"{\__/}" "\n(●_●)" "\n( >🌮 Want a taco?")


@galoncmd(pattern=r"^\.paw$")
async def paw(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@galoncmd(pattern=r"^\.tf$")
async def tf(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")


@galoncmd(pattern=r"^\.gey$")
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
...
@galoncmd(pattern=r"^\.(?:penis|dick)\s?(.)?")
