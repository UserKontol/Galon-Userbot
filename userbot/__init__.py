...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/43fbaa4bca9df50b339c0.jpg"
...
WEATHER_DEFCITY = os.environ.get("WEATHER_DEFCITY", "Semarang")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "Galon-Userbot")
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO", "https://telegra.ph/file/253a53da9a31ba3ab4b16.jpg")

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC", "https://telegra.ph/file/253a53da9a31ba3ab4b16.jpg")
...
with bot:
    try:
        ...
        LOGS.info(
            "BOTLOG_CHATID environment variable isn't a valid entity. Check your environment variables.")
        quit(1)
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Galon-Userbot v{BOT_VER} is back up and running!**\n\n"
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"** Galon-Userbot Inline Menu **\n\n **Owner** [{user.first_name}](tg://user?id={user.id})\n **Jumlah** `{len(dugmeler)}` Modules"
                await event.edit(
                    text,
                    file=roselogo,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository Galon - Userbot",
                    url="https://t.me/GalonSupport",
                ...
                result = builder.article(
                    title=" Galon-Userbot ",
                    description="Galon - Userbot | Telethon",
                    url="https://t.me/GalonUpdates",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
